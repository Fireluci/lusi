...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            find = search.split(" ")
            search = ""
            removes = ["in","upload", "series", "and", "&", "hollywood", "download", "kdrama", "audio", "webseries", "language", "horror", "movi", "movie", "hd", "4k", "film", "seasons", "dub", "dubbed", "send", "dupped", "2k", "bollywood", "anime", "netflix", "print", "file"]
            for x in find:
                if x in removes:
                    continue
                else:
...
async def advantage_spell_chok(client, msg):
    ...
    find = mv_rqst.split(" ")
    query = ""
    removes = ["in","upload", "series", "and", "&", "kdrama", "hollywood", "download", "audio", "webseries", "language", "horror", "movi", "movie", "hd", "4k", "film", "seasons", "dub", "dubbed", "send", "dupped", "2k", "bollywood", "anime", "netflix", "print", "file"]
    for x in find:
        if x in removes:
            continue
        else:
